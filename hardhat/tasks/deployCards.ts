...
import { persistCardsContractAddress } from "../utils/contract"
import { promptForGasPrice } from "../utils/gas"

task("deployCards", "Deploy cards contract", async (taskArgs, hre) => {
  ...
  persistCardsContractAddress(hre, deployed.address)
